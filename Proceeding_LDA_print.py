...
def lda_print(CountVectorizer, lda, n_features):
    ...
    for topic_idx, words in enumerate(lda.components_):
        topic = [each_ngram_word[item] for item in words.argsort()[:-(n_features*0.1+1):-1]]
...
# Ingredients for LDA
# Perplexity
saved_path = "/Users/osuhyeon/NLTK_court_document/(2,3) LDA Perplexities/"
...
saveTextDictionary = "/Users/osuhyeon/NLTK_court_document/(2,3) LDA Text Dictionary/"
